...
public class DurGame {
	...
	public static ImageView blueScoreFirstDig = ImageFactory.createIV(970, 110, 38, 63, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));	
	public static ImageView blueScoreSecDig = ImageFactory.createIV(930, 110, 38, 63, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));	
	public static ImageView blueScoreThiDig = ImageFactory.createIV(890, 110, 38, 63, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));	
	public static ImageView blueScoreFourDig = ImageFactory.createIV(850, 110, 38, 63, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));	
	...
	public static ImageView redScoreFirstDig = ImageFactory.createIV(430, 110, 38, 63, Main.getNum(gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDPENELTY, 3));	
	public static ImageView redScoreSecDig = ImageFactory.createIV(390, 110, 38, 63, Main.getNum(gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDPENELTY, 2));	
	public static ImageView redScoreThiDig = ImageFactory.createIV(350, 110, 38, 63, Main.getNum(gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDPENELTY, 1));
	public static ImageView redScoreFourDig = ImageFactory.createIV(310, 110, 38, 63, Main.getNum(gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDPENELTY, 0));	

	//end of red cargo amounts
		
	//time reMainied till and of game
	//TODO : 0?????
	public static ImageView timeones = ImageFactory.createIV(695, 201, 11, 18, Main.getNum(0, 2));
	public static ImageView timeTens = ImageFactory.createIV(681, 201, 11, 18, Main.getNum(0, 1));
	public static ImageView timeMins = ImageFactory.createIV(656, 201, 11, 18, Main.getNum(0, 0));
