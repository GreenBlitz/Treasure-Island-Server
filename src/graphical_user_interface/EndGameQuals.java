...
public class EndGameQuals {
	...
	public static ImageView redStackPointsSecDig = ImageFactory.createIV(333, 405, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS, 1));
	public static ImageView redStackPointsThiDig = ImageFactory.createIV(346, 405, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS, 2));
