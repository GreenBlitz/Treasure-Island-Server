...
public class EndGameFinals {
	...
	public static ImageView blueStackPointsFirstDig = ImageFactory.createIV(955, 405, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS, 0));
	public static ImageView blueStackPointsSecDig = ImageFactory.createIV(942, 405, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS, 0));
	public static ImageView blueStackPointsThiDig = ImageFactory.createIV(929, 405, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS, 0));
	public static ImageView blueStackPointsFourDig = ImageFactory.createIV(916, 405, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS, 0));
	...
	public static ImageView blueTotalPointsFirstDig = ImageFactory.createIV(949, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));
	public static ImageView blueTotalPointsSecDig = ImageFactory.createIV(936, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));
	public static ImageView blueTotalPointsThiDig = ImageFactory.createIV(923, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));
	...
	public static ImageView redTotalPointsFirstDig = ImageFactory.createIV(361, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 0));
	public static ImageView redTotalPointsSecDig = ImageFactory.createIV(348, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 0));
	public static ImageView redTotalPointsThiDig = ImageFactory.createIV(335, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 0));
