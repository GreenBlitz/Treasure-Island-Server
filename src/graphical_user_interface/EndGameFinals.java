...
public class EndGameFinals {
	//Teams
	public static ImageView redTeam1 = ImageFactory.createIV(275, 222, 11, 18, Main.getNum(gameParams.RED1, 0));
	public static ImageView redTeam2 = ImageFactory.createIV(525, 222, 11, 18, Main.getNum(gameParams.RED2, 0));
	public static ImageView blueTeam1 = ImageFactory.createIV(855, 222, 11, 18, Main.getNum(gameParams.BLUE1, 0));
	public static ImageView blueTeam2 = ImageFactory.createIV(1105, 222, 11, 18, Main.getNum(gameParams.BLUE2, 0));
	//End of teams
	...
	public static ImageView blueStackPointsFirstDig = ImageFactory.createIV(942, 405, 11, 18, Main.getNum(gameParams.BLUESTACKPOINTS, 0));
	public static ImageView blueStackPointsSecDig = ImageFactory.createIV(929, 405, 11, 18, Main.getNum(gameParams.BLUESTACKPOINTS, 1));
	public static ImageView blueStackPointsThiDig = ImageFactory.createIV(916, 405, 11, 18, Main.getNum(gameParams.BLUESTACKPOINTS, 2));
	...
	public static ImageView blueTotalPointsFirstDig = ImageFactory.createIV(936, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 0));
	public static ImageView blueTotalPointsSecDig = ImageFactory.createIV(923, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 1));
	public static ImageView blueTotalPointsThiDig = ImageFactory.createIV(910, 605, 11, 18, Main.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 2));
	//End of blue points
	...
	public static ImageView redStackPointsFirstDig = ImageFactory.createIV(320, 405, 11, 18, Main.getNum(gameParams.REDSTACKPOINTS, 0));
	public static ImageView redStackPointsSecDig = ImageFactory.createIV(333, 405, 11, 18, Main.getNum(gameParams.REDSTACKPOINTS, 1));
	public static ImageView redStackPointsThiDig = ImageFactory.createIV(346, 405, 11, 18, Main.getNum(gameParams.REDSTACKPOINTS, 2));
	...
	public static ImageView redTotalPointsFirstDig = ImageFactory.createIV(348, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 0));
	public static ImageView redTotalPointsSecDig = ImageFactory.createIV(335, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 1));
	public static ImageView redTotalPointsThiDig = ImageFactory.createIV(322, 605, 11, 18, Main.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 2));
	//End of red points
