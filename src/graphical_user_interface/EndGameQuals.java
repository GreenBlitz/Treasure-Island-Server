...
public class EndGameQuals {
	...
	//Teams numbers
	public static ImageView redTeam1 = ImageFactory.createIV(235, 225, 11, 18, Maini.getNum(gameParams.RED1, 0));
	public static ImageView redTeam2 = ImageFactory.createIV(485, 225, 11, 18, Maini.getNum(gameParams.RED2, 0));
	public static ImageView blueTeam1 = ImageFactory.createIV(815, 225, 11, 18, Maini.getNum(gameParams.BLUE1, 0));
	public static ImageView blueTeam2 = ImageFactory.createIV(1065, 225, 11, 18, Maini.getNum(gameParams.BLUE2, 0));
	//team ranks
	public static ImageView redRank1 = ImageFactory.createIV(337, 225, 11, 18, Maini.getNum(gameParams.getRank(gameParams.RED1), 0));
	public static ImageView redRank2= ImageFactory.createIV(587, 225, 11, 18, Maini.getNum(gameParams.getRank(gameParams.RED2), 0));
	public static ImageView blueRank1 = ImageFactory.createIV(912, 225, 11, 18, Maini.getNum(gameParams.getRank(gameParams.BLUE1), 0));
	public static ImageView blueRank2 = ImageFactory.createIV(1162, 225, 11, 18, Maini.getNum(gameParams.getRank(gameParams.BLUE2), 0));
	...
	public static ImageView redRPTotal= ImageFactory.createIV(530, 470, 17, 27, Maini.getNum(/*total RP earned needed*/0, 0));
	//End of red RP
	...
	public static ImageView redTotalPointsFirstDig = ImageFactory.createIV(361, 605, 11, 18, Maini.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 3));
	public static ImageView redTotalPointsSecDig = ImageFactory.createIV(348, 605, 11, 18, Maini.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 2));
	public static ImageView redTotalPointsThiDig = ImageFactory.createIV(335, 605, 11, 18, Maini.getNum(gameParams.REDCARGOPOINTS+gameParams.REDSTACKPOINTS+gameParams.REDANCHORPOINTS+gameParams.REDCANNONPOINTS+gameParams.REDPENELTY, 1));
	...
	public static ImageView blueRPTotal= ImageFactory.createIV(1120, 470, 17, 27, Maini.getNum(0, 0));
	//End of blue RP
	...
	public static ImageView blueStackPointsFirstDig = ImageFactory.createIV(955, 405, 11, 18, Maini.getNum(gameParams.BLUESTACKPOINTS, 0));
	public static ImageView blueStackPointsSecDig = ImageFactory.createIV(942, 405, 11, 18, Maini.getNum(gameParams.BLUESTACKPOINTS, 0));
	public static ImageView blueStackPointsThiDig = ImageFactory.createIV(929, 405, 11, 18, Maini.getNum(gameParams.BLUESTACKPOINTS, 0));
	public static ImageView blueStackPointsFourDig = ImageFactory.createIV(916, 405, 11, 18, Maini.getNum(gameParams.BLUESTACKPOINTS, 0));
	...
	public static ImageView blueTotalPointsFirstDig = ImageFactory.createIV(949, 605, 11, 18, Maini.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 3));
	public static ImageView blueTotalPointsSecDig = ImageFactory.createIV(936, 605, 11, 18, Maini.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 2));
	public static ImageView blueTotalPointsThiDig = ImageFactory.createIV(923, 605, 11, 18, Maini.getNum(gameParams.BLUECARGOPOINTS+gameParams.BLUESTACKPOINTS+gameParams.BLUEANCHORPOINTS+gameParams.BLUECANNONPOINTS+gameParams.BLUEPENELTY, 1));
